...
### 1. NEW: `src/Paperoni.Contract/ValidationContext.cs`
...
### 2. NEW: `src/Paperoni.Contract/ValidationException.cs`
...
| File | Action |
|------|--------|
| `src/Paperoni.Contract/ValidationContext.cs` | NEW |
| `src/Paperoni.Contract/ValidationException.cs` | NEW |
